...
class InstallerTests(unittest.TestCase):
    ...
    def test_real_core_and_ui_bundle_without_sibling(self):
        ...
        self.assertTrue({'game-ui-ux-design', 'game-workflow-audit'} <= expected)
        ...
        self.assertTrue((self.target / 'game-ui-ux-design/references/output-contract.md').is_file())
        self.assertTrue((self.target / 'game-workflow-audit/references/output-contract.md').is_file())
