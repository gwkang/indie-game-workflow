...
2. Translate the persona into no more than three observable design consequences (for example: primary task prominence, information density, or motion restraint). Keep these consequences provisional until the product owner confirms them.
