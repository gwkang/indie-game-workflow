...
5. Run game-functional-verification on the assembled candidate, apply the delivery contract's code-review decision and required final gates, and resolve findings through their owners. Mark completion only against current evidence and required acceptance decisions.
