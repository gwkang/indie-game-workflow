...
4. Return immutable candidate hashes and fidelity evidence. Keep DRAFT until exact selection under the shared UI decision rules; never turn a mockup into a runtime texture.
